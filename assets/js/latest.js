...
document.getElementById('tag1').innerHTML = '<a href="'+tagsearch(tag01)+'/'+tagsearch(tag01)+'.html" target="_parent">'+tag01+'</a>';
...
document.getElementById('tag2').innerHTML = '<a href="'+tagsearch(tag02)+'/'+tagsearch(tag02)+'.html">'+tag02+'</a>';
...
document.getElementById('tag3').innerHTML = '<a href="'+tagsearch(tag03)+'/'+tagsearch(tag03)+'.html">'+tag03+'</a>';
...
document.getElementById('tag4').innerHTML = '<a href="'+tagsearch(tag04)+'/'+tagsearch(tag04)+'.html">'+tag04+'</a>';
...
document.getElementById('tag5').innerHTML = '<a href="'+tagsearch(tag05)+'/'+tagsearch(tag05)+'.html">'+tag01+'</a>';
